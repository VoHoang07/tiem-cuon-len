...
export default function EditProductScreen() {
  ...
  if (!existingProduct) {
    return (
      <SafeAreaView style={styles.safe}>
        <View style={styles.accessDenied}>
          <Text style={styles.accessDeniedText}>Không tìm thấy sản phẩm</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView
        ...
        {image ? (
          ...
          <View style={styles.imagePickerArea}>
            <View style={styles.imagePlaceholder}>
              ...
              <Text style={styles.imagePlaceholderSubtext}>Chụp ảnh hoặc chọn từ thư viện</Text>
            </View>
            <View style={styles.imageBtnRow}>
              ...
              <TouchableOpacity style={[styles.imageBtn, styles.imageBtnOutline]} onPress={pickFromGallery}>
                <ImageIcon size={20} color={COLORS.primary} />
                <Text style={styles.imageBtnTextOutline}>{AP_CHOOSE_FROM_GALLERY}</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
        ...
        <View style={styles.form}>
          <FormField label={AP_PRODUCT_NAME} value={name} onChangeText={setName} placeholder={AP_PRODUCT_NAME_PLACEHOLDER} />
          <FormField label={AP_PRICE} value={price} onChangeText={setPrice} placeholder={AP_PRICE_PLACEHOLDER} keyboardType="numeric" />
          ...
          <FormField label={AP_MATERIAL} value={material} onChangeText={setMaterial} placeholder={AP_MATERIAL_PLACEHOLDER} />
          <FormField label={AP_COLOR_FIELD} value={color} onChangeText={setColor} placeholder={AP_COLOR_PLACEHOLDER} />
          <FormField label={AP_QUANTITY} value={quantity} onChangeText={setQuantity} placeholder={AP_QUANTITY_PLACEHOLDER} keyboardType="numeric" />
          <FormField label={AP_TAGS_LABEL} value={tags} onChangeText={setTags} placeholder={AP_TAGS_PLACEHOLDER} />

          <TouchableOpacity style={styles.generateBtn} onPress={generateDescription}>
          ...
          <TouchableOpacity style={styles.submitBtn} onPress={handleSubmit}>
            <Text style={styles.submitBtnText}>Cập nhật sản phẩm</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  imagePickerArea: { marginHorizontal: SPACING.lg, marginBottom: SPACING.lg },
  imagePlaceholder: {
    alignItems: 'center',
    justifyContent: 'center',
  ...
  imagePlaceholderTitle: { fontSize: 16, fontWeight: '700', color: COLORS.primary, marginTop: SPACING.sm },
  imagePlaceholderSubtext: { fontSize: 13, color: COLORS.mediumText },
  imageBtnRow: { flexDirection: 'row', gap: SPACING.md },
  imageBtn: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  imageBtnOutline: { backgroundColor: COLORS.white, borderWidth: 2, borderColor: COLORS.primary },
  imageBtnText: { fontSize: 14, fontWeight: '700', color: COLORS.white },
  imageBtnTextOutline: { fontSize: 14, fontWeight: '700', color: COLORS.primary },
  imagePreviewContainer: { marginHorizontal: SPACING.lg, marginBottom: SPACING.lg },
  previewImageLarge: { width: '100%', height: 280, borderRadius: 20, resizeMode: 'cover', marginBottom: SPACING.md },
  imageActionsRow: { flexDirection: 'row', gap: SPACING.sm, justifyContent: 'center' },
  imageActionBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  imageActionBtnDanger: { backgroundColor: '#FDF0ED' },
  imageActionText: { fontSize: 12, fontWeight: '600', color: COLORS.primary },
  imageActionTextDanger: { fontSize: 12, fontWeight: '600', color: COLORS.error },
  ...
  categoryChipText: { fontSize: 14, fontWeight: '600', color: COLORS.mediumText },
  ...
  generateBtnText: { fontSize: 16, fontWeight: '800', fontStyle: 'italic', color: COLORS.white },
  descriptionPreview: { backgroundColor: COLORS.lightPurple, borderRadius: 12, padding: SPACING.lg, marginBottom: SPACING.lg },
  descriptionLabel: { fontSize: 14, fontWeight: '700', color: COLORS.primary, marginBottom: SPACING.sm },
  descriptionText: { fontSize: 15, lineHeight: 22, color: COLORS.darkText },
  submitBtn: { backgroundColor: COLORS.primary, borderRadius: 20, paddingVertical: 16, alignItems: 'center', ...SHADOWS.medium },
  submitBtnText: { fontSize: 18, fontWeight: '900', fontStyle: 'italic', color: COLORS.white },
  accessDenied: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 120 },
  accessDeniedText: { fontSize: 18, fontWeight: '700', color: COLORS.warmBrown },
});
